  ...
  return (
    <div className="min-h-screen max-w-4xl mx-auto flex justify-center gap-8 items-center flex-col p-6">
      ...
      <p className="text-lg text-muted-foreground text-center max-w-3xl">
        ...
        learn and master HTML, CSS, and JavaScript. Whether you're a beginner or an
        experienced developer, these projects will challenge your skills and inspire
        creativity. Start building today and take your development journey to the
        next level!
      </p>
      <div className="w-full flex flex-col gap-6">
        <section className="bg-muted p-6 rounded-lg shadow-md">
          ...
          <p className="text-foreground mt-2">
            Building projects is one of the best ways to learn programming. It allows
            you to apply theoretical knowledge in a practical way, solve real-world
            problems, and create a portfolio that showcases your skills to potential
        ...
        <section className="bg-muted p-6 rounded-lg shadow-md">
          ...
          <ul className="list-disc list-inside text-foreground mt-2">
