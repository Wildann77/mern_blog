    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          ...
          <div className="text-md text-muted-foreground flex flex-col gap-6">
            <p>
              Welcome to Sahand's Blog! This blog was created by Sahand Ghavidel as a
            ...
            <p>
              On this blog, you'll find weekly articles and tutorials on topics such
              as web development, software engineering, and programming languages.
              Sahand is always learning and exploring new technologies, so be sure to
